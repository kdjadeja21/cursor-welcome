...
export const ORBIT_BOTS: readonly OrbitBot[] = [
  ...
  { id: "5", fill: "#2563eb", size: RING_SIZE, angleDeg: STEP_DEG * 4 },
  { id: "6", fill: "#f08a24", size: RING_SIZE, angleDeg: STEP_DEG * 5 },
  { id: "7", fill: "#8b5cf6", size: RING_SIZE, angleDeg: STEP_DEG * 6 },
  { id: "8", fill: "#3ecf8e", size: RING_SIZE, angleDeg: STEP_DEG * 7 },
  { id: "9", fill: "#14b8a6", size: RING_SIZE, angleDeg: STEP_DEG * 8 },
  { id: "10", fill: "#8b5e3c", size: RING_SIZE, angleDeg: STEP_DEG * 9 },
  { id: "11", fill: "#2563eb", size: RING_SIZE, angleDeg: STEP_DEG * 10 },
  { id: "12", fill: "#f08a24", size: RING_SIZE, angleDeg: STEP_DEG * 11 },
  { id: "13", fill: "#3ecf8e", size: RING_SIZE, angleDeg: STEP_DEG * 12 },
