...
- Treat query strings as literal (`title`, `day`, `seconds` on `/countdown`).
...
- [Countdown bumper](./countdown-bumper.md) is `/countdown` with title, timer, blob ring, and Day 2 label.
