...
The Rive intro plays once on load, then the welcome stage takes over with a large SpaceXAI wordmark as the centrepiece.

## Features

- Two branding themes: SpaceXAI (default, monochrome, Rive loading intro + large wordmark on stage) and Cursor (orange accent, animated SVG mark)
